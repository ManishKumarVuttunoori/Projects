...
{   
    try
    {
        ...
        cout<<"Computed Digest is "<<computedDigest<<endl; cout<<"\nGiven digest is "<<digest<<endl; 
    ...
    {
        HelperClass::TerminateApplication("unable to handle packet");
    }    
}
...
{   
    ...
    {
        HelperClass::TerminateApplication("Error in parsing packet");
    }        
}
...
{   
      try
	    ...
	    {
             HelperClass::TerminateApplication("Error in Handling the socket");
        }    
